        ...
        <div className="container grid lg:grid-cols-4 md:grid-cols-2 pb-[20px]">
            <div>
                ...
                <div className="mt-[10px] flex flex-col gap-[10px]">
                    <p className='hover:text-[#1e90ff] hover:underline transition-all duration-300 cursor-pointer'>Home</p>
                    <p className='hover:text-[#1e90ff] hover:underline transition-all duration-300 cursor-pointer'>About</p>
                    <p className='hover:text-[#1e90ff] hover:underline transition-all duration-300 cursor-pointer'>Places</p>
                    <p className='hover:text-[#1e90ff] hover:underline transition-all duration-300 cursor-pointer'>Review</p>
                    <p className='hover:text-[#1e90ff] hover:underline transition-all duration-300 cursor-pointer'>Contact Us</p>
                </div>
            </div>
